...
<div class="row">
  ...
  <div class="col-sm-4" style="text-align: center;">
    <div class="card-block" style="padding-bottom: 27px;">
      <p class="card-text" id="texto_tweet">
        <h2 style=" font-weight: bold; color:#777777;">Centro de Atención y Cuidado Infantil</h2>
        <h2 style="font-weight: bold; color:#235B4E;">Mtra. Eva Moreno Sánchez</h2>
    ...
    <div class="card-block">
      <p class="card-text" id="texto_tweet">
        <div class="blog-img">
          <a href="instalaciones_Eva_Moreno">
